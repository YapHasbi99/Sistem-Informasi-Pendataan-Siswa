    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SI SMK SWASTA AMAL BAKTI</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Pendataan Berkas Siswa</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>NIS</th><th width="20%">Nama</th><th>Kelas</th><th>Alamat</th><th>Gender</th><th>Asal Sekolah</th>
                            </tr>
                        </thead>
                        <tbody>
